---
type: source
source_id: horizon-99b09ea2d11b010b
source_type: horizon-digest
title: "Horizon Summary: 2026-08-13 (ZH)"
author: Horizon
url: https://aaawangbo.github.io/Horizon/2026/08/13/summary-zh.html
published: 2026-08-13
captured: 2026-08-15
processed: true
language: zh
content_hash: de59766c7e09aa05e26b843d127a401d61eb50c9b2d3a33bbdecb6fa4b504af4
tags:
  - horizon
  - daily-digest
  - ai-news
...
> [!source] 原始日报
> [打开 Horizon 页面](https://aaawangbo.github.io/Horizon/2026/08/13/summary-zh.html)。本记录由自动流程保存，知识页中的关键事实仍应回到日报所列的第一方链接核验。
...
- [Qwen 发布 2.4T MoE 开源模型](#item-ai-blogger-1) ⭐️ 10.0/10

 
- [Pixel Watch 5 发布：健康趋势成亮点](#item-ai-blogger-2) ⭐️ 9.0/10

 
- [DeepSeek V4 Pro 0813 上线 OpenRouter](#item-ai-blogger-3) ⭐️ 8.0/10

 
- [Tailscale 复盘 16 年 SQLite WAL 重置 bug](#item-ai-blogger-4) ⭐️ 8.0/10

 
- [Lovable 完成 4 亿美元 C 轮融资，估值 133 亿美元](#item-ai-blogger-5) ⭐️ 8.0/10

 
- [DeepMind 推出手语转文字模型 SL2T](#item-ai-blogger-6) ⭐️ 8.0/10

 
- [窃取专有大模型推理轨迹的新研究](#item-ai-blogger-7) ⭐️ 8.0/10

 
- [多智能体 LLM 系统的“心智病毒”研究](#item-ai-blogger-8) ⭐️ 8.0/10

 
- [LinkedIn 自进化客服 Agent 提升显著](#item-ai-blogger-9) ⭐️ 8.0/10

 
- [DSAgentBench：衡量智能体完成真实数据科学任务](#item-ai-blogger-10) ⭐️ 8.0/10

 
- [RLMOpt：递归语言模型提示优化新方法](#item-ai-blogger-11) ⭐️ 8.0/10

 
- [MAP-Graph：多智能体溯源感知共享内存](#item-ai-blogger-12) ⭐️ 8.0/10

 
- [林俊旸 Agent 创业获腾讯投资，估值 135 亿](#item-ai-blogger-13) ⭐️ 8.0/10

 
- [AI 刷分与科研能力差距引热议](#item-ai-blogger-14) ⭐️ 8.0/10

 
- [Adam 的逐坐标自适应会丢失低秩偏置](#item-ai-blogger-15) ⭐️ 8.0/10

 
- [OpenAI SDK v3.0.0 默认 HTTPX2](#item-ai-blogger-16) ⭐️ 7.0/10

 
- [Zed 推出 Delta 协作新功能](#item-ai-blogger-17) ⭐️ 7.0/10

 
- [LiquidAI 发布 3B 边缘视觉模型](#item-ai-blogger-18) ⭐️ 7.0/10

 
- [AI 改写无无损变换：工程师需为每个句子负责](#item-ai-blogger-19) ⭐️ 7.0/10
...
- [Google brings blood pressure and insulin resistance tracking ...](https://gadgetsandwearables.com/2026/08/12/google-health-guardian-blood-pressure-insulin-resistance/)

- [Pixel Watch 5 Targets Pre-Diabetes Risk With First Wrist ...](https://www.techtimes.com/articles/324209/20260812/pixel-watch-5-targets-pre-diabetes-risk-first-wrist-based-insulin-resistance-tracking.htm)

- [Google unveils the Pixel Watch 5 with a smarter Gemini and ...](https://techcrunch.com/2026/08/12/google-unveils-the-pixel-watch-5-with-a-smarter-gemini-and-advanced-health-monitoring/)
...
- [Lovable Raises $400M, Doubling Valuation to $13.3B in Series C Funding](https://www.globalbankingandfinance.com/vibe-coding-startup-lovable-raises-400-million-13-3-billion/)

- [Lovable Series C Funding Hits $400M as Valuation Doubles to $13.3B](https://en.cryptonomist.ch/2026/08/12/lovable-series-c-funding/)
...
- [Google DeepMind unveils SignGemma, a sign language to text model](https://www.linkedin.com/posts/ai-apps-central_ai-deepmind-signlanguage-activity-7359561540204752898-Ph8u)

- [Google ’s Pixel 11 can translate American Sign Language into text](https://mashable.com/tech/google-pixel-11-asl-sign-to-text)
...
**「内容角度」** \1. 安全机制拆解：结合论文中的 curl 示例，解释 OpenAI Responses API 中的 reasoning.encrypted_content 字段是什么，以及同一模型家族共用密钥为何是漏洞根源。
...
- [曝林俊旸获腾讯投资：首轮估值135亿，新一轮融资已开启-36氪](https://www.36kr.com/p/3854438054417670)

- [林俊旸Agent创业首次亮相，腾讯已投_创事记_新浪科技_新浪网](https://finance.sina.com.cn/tech/csj/2026-08-12/doc-inimzqcp6912459.shtml)

- [曝林俊旸获腾讯投资：首轮估值135亿，新一轮融资已开启 - 知乎](https://zhuanlan.zhihu.com/p/2049983053402051226)
...
- [BenchTrace: The AI Benchmark Shaking Up Self-Evolution](https://www.machinebrief.com/news/benchtrace-the-ai-benchmark-shaking-up-self-evolution-km7k)
...
- [Zed Launches DeltaDB Version Control System with Fine-Grained Code Tracking | KuCoin](https://www.kucoin.com/news/flash/zed-launches-deltadb-version-control-system-with-fine-grained-code-tracking)

- [Zed — Your last next editor](https://zed.dev/)

- [Zed Delta: Multiplayer Coding Environment for AI Agents | AIToolly](https://aitoolly.com/ai-news/article/2026-08-13-zed-introduces-delta-a-new-multiplayer-environment-for-collaborative-coding-with-ai-agents-and-real)
...
- [LFM 2 . 5 - VL - 3 B : A Better and Faster Vision - Language Model for the...](https://www.liquid.ai/blog/lfm2-5-vl-3b)

- [Liquid AI releases LFM 2 . 5 - VL - 3 B for faster edge vision capabilities](https://korshunov.ai/en/article/18015-liquid-ai-releases-lfm2-5-vl-3b-for-faster-edge-vision-capabilities/)

- [Liquid AI releases LFM 2 . 5 - VL - 3 B for edge vision tasks — Snippora](https://snippora.com/tools/liquid-ai-releases-lfm25-vl-3b-for-edge-vision-tasks-3228)
