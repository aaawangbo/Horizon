---
type: source
source_id: horizon-db2bf9f82ae13820
source_type: horizon-digest
title: "Horizon Summary: 2026-08-05 (ZH)"
author: Horizon
url: https://aaawangbo.github.io/Horizon/2026/08/05/summary-zh.html
published: 2026-08-05
captured: 2026-08-07
processed: true
language: zh
content_hash: 83ac2948d28af5789578275b0535c183961523a9ddcafed6c30f35077c81746b
tags:
  - horizon
  - daily-digest
  - ai-news
...
# Horizon Summary: 2026-08-05 (ZH)

> [!source] 原始日报
> [打开 Horizon 页面](https://aaawangbo.github.io/Horizon/2026/08/05/summary-zh.html)。本记录由自动流程保存，知识页中的关键事实仍应回到日报所列的第一方链接核验。
...
- [Qwen2.5 浮现性失对准：可移植人格方向](#item-ai-blogger-1) ⭐️ 9.0/10

 
- [微信支付 SeqLLM 提升风控精度](#item-ai-blogger-2) ⭐️ 9.0/10

 
- [Sand.ai 开源千亿 MoE 视频生成模型](#item-ai-blogger-3) ⭐️ 9.0/10

 
- [WebKit 代理与 iCloud 中继泄漏](#item-ai-blogger-4) ⭐️ 8.0/10

 
- [国际刑警：AI 助长非洲逾半网络犯罪](#item-ai-blogger-5) ⭐️ 8.0/10

 
- [Waymo 在达拉斯向公众开放](#item-ai-blogger-6) ⭐️ 8.0/10

 
- [Xbox 服务中断致光盘游戏无法运行](#item-ai-blogger-7) ⭐️ 8.0/10

 
- [Apple Silicon 本地跑 MiniMax-H3 视频生成](#item-ai-blogger-8) ⭐️ 8.0/10

 
- [ParamBench：面向工具调用参数生成的难度分级基准](#item-ai-blogger-9) ⭐️ 8.0/10

 
- [智能体经济行为自发涌现？arXiv 新实验](#item-ai-blogger-10) ⭐️ 8.0/10

 
- [基准提升不等于能力扩展：问题级审计](#item-ai-blogger-11) ⭐️ 8.0/10

 
- [开源版 Claude Science：MIT 协议、零依赖、30+科研技能](#item-ai-blogger-12) ⭐️ 8.0/10

 
- [Ollama v0.32.6-rc0：苹果 GPU 提速与流式兼容](#item-ai-blogger-13) ⭐️ 7.0/10

 
- [Mistral 发布 3B 开源多模态审核模型](#item-ai-blogger-14) ⭐️ 7.0/10

 
- [Maple-Preview：iPhone 端 20B 三元 MoE](#item-ai-blogger-15) ⭐️ 7.0/10

 
- [AI 编程八大误区：开发者怎么看](#item-ai-blogger-16) ⭐️ 7.0/10

 
- [LLM 0.32 发布，新增推理轨迹与服务端工具](#item-ai-blogger-17) ⭐️ 7.0/10
...
- [Sand.ai Open-Sources What It Calls the First 100B-Parameter MoE Video ...](https://zglg.work/en/ai/news/2026-08-05-sand-ai-open-sources-what-it-calls-the-first-100b-parameter-moe-video-generat)

- [GitHub - SandAI-org/MAGI-2-preview: MAGI-2-preview: Scaling Video ...](https://github.com/SandAI-org/MAGI-2-preview)
...
- [IP and DNS Leaks in WebKit Affecting Proxy Browsers and Apple iCloud ...](https://mysk.blog/2026/08/04/webkit-proxy-icloud-private-relay-ip-leak/)

- [WebKit leaks in iOS & macOS expose user data in spite of proxy use](https://appleinsider.com/articles/26/08/05/webkit-leaks-in-ios-macos-expose-ip-and-dns-in-spite-of-proxy-use)

- [iCloud Private Relay can leak your IP due to issues with WebKit. This ...](https://x.com/mysk_co/status/2084773794380677264)
...
- [INTERPOL report finds AI linked to more than half of cybercrime in Africa](https://www.interpol.int/en/News-and-Events/News/2026/INTERPOL-report-finds-AI-linked-to-more-than-half-of-cybercrime-in-Africa)

- [INTERPOL AFRICAN CYBERTHREAT ASSESSMENT REPORT 2026 JUNE 2026](https://www.interpol.int/Media/Documents/Publications/Cybercrime/African-Cyberthreat-Assessment-Report-2026)

- [AI powers 55% of African cybercrimes, INTERPOL 2026 report reveals](https://punchng.com/ai-powers-55-of-african-cybercrimes-interpol-2026-report-reveals/)
...
- [August 4, 2026 - From the road - Waymo](https://waymo.com/blog/shorts/dallas-open-to-all/)
...
- [Xbox Outage Locked Players Out of Discs They Own](https://tech.yahoo.com/gaming/articles/xbox-outage-locked-players-discs-154143617.html)

- [Xbox Addresses Disc Failing Issue During Network Outage](https://gamerant.com/xbox-outage-disc-failing-update/)

- [Xbox Outage Blocked Disc Games: Why Physical Media Isn't ...](https://windows.gadgethacks.com/news/xbox-outage-blocked-disc-games-why-physical-media-isnt-offline-access/)
...
**「内容角度」** \1. 提示词对视频模型音频的影响：以 Simon 未读 Prompting Guide 生成了类语音噪声为案例，展示 MiniMax-H3 的 VIDEO_PROMPT_WRITING_GUIDE 如何改变视频与音频控制，值得做一次对照实验。
...
- [量子位：北大&元空AI Agent联合实验室开源科研智能体 OpenAI4SClaude ...](https://juejin.cn/post/7669809799602896948)

- [量子位：北大&元空AI Agent联合实验室开源科研智能OpenAI4S](https://blog.csdn.net/weixin_73089104/article/details/163479917)

- [开源版 Claude Science 发布：零依赖 MIT 科研 Agent 内置 30+ Skills...](https://www.openai-hub.com/news/1409/)
...
Ollama 官方 GitHub 仓库发布了 v0.32.6-rc0 发布候选版本。该版本让 MLX 引擎在苹果 GPU 上自动使用模型的 MTP 头对 Qwen3.5 进行推测解码，宣称可提升速度；同时修复了 /v1/chat/completions 流式输出与 OpenAI 格式不一致的问题，并让截断响应返回 finish_reason 为 length。还新增了 ollama run kimi-k3 对 kimi-k3:cloud 云模型标签的提示。此外，实验性图像生成功能被暂时移除，官方建议需要图像生成的用户继续使用 0.32.5。由于这是 RC 版本，尚未正式稳定发布。

github · github-actions[bot] · 8月4日 18:49

**「为什么重要」** 对使用 OpenAI 兼容接口的开发者来说，流式响应格式和截断 finish_reason 的修复能减少客户端解析差异；使用 Apple Silicon 的用户在跑 Qwen3.5 时可能获得更快的推理速度。不过这是发布候选版，且图像生成被临时移除，生产环境或依赖图像生成的流程应谨慎升级，或继续使用 0.32.5。

**「内容角度」** \1. 实测对比：RC 版在 Apple Silicon 上跑 Qwen3.5 的提速幅度和内存占用变化，验证 MLX MTP 头推测解码的实际收益。
\2. OpenAI 兼容流式响应格式逐块对照：role、finish_reason、usage 分块是否真的与官方一致，适合做一次快速验证。
...
- [Maple-Preview - On-device ternary 20B MoE reasoning LLM](https://zeli.app/en/story/49173984)

- [Maple-Preview: The 'Moore's Law' Moment for On-Device AI, Hitting 120 ...](https://baguaai.com/maple-preview-the-moores-law-moment-for-on-device-ai-hitting-120-tok-s-with-a-20b-moe-on-iphone/)

- [Maple-Preview: A Ternary 20B MoE at 120 tok/s on an iPhone](https://ideaverse.ai/blog/maple-preview-a-ternary-20b-moe-at-120-tok-s-on-an-iphone-msfa685t)
...
- [Eight Myths on Software Engineering and GenAI | Queue](https://spawn-queue.acm.org/doi/10.1145/3807963)
...
**「内容角度建议」** \1. 上手实测：对比 llm 命令的推理轨迹显示与 Python API 的 stream_events()，展示如何按 reasoning / text / tool_call 事件类型分别消费模型输出。
