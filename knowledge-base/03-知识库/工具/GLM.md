...
- **GLM-5.3-Flash 发布**（2026-08-26）：Hugging Face Transformers v5.16.1 正式支持。GLM-5 系列首个原生多模态模型，320B 总参/18B 激活，混合稀疏+线性注意力架构，Manifold-Constrained Hyper-Connections（mHC），基于 30T token 多模态预训练。官方宣称性能优于 GLM-5.2、价格为其十分之一，编码与智能体任务接近 Claude Opus 4.8，但无独立验证。
...
- GLM-5.3 与 GLM-5.3-Flash 的官方基准和独立复现尚未公开，需谨慎看待其评估口径。
