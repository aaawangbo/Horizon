...
- **定位**：Qwen4 架构的早期预览，开放权重多模态 MoE 模型。
- **参数**：总参 125B，激活 6B。
- **测试**：Simon Willison 在 DGX Spark 上使用 Unsloth 量化版（UD-IQ1_S 72.5GB、UD-Q2_K_XL 78.9GB）进行图像生成测试。
- **注意**：尚无完整基准测试，官方仅称“早期预览”，最终架构可能变化。
- **推断**：125B/6B 的 MoE 设计意味着高效推理与本地部署成本优势。
